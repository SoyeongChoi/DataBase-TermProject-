...
<body>
   ...
   <%
      ...
      try {
         ...
         String p = "select 영화아이디 from 상영관 where 상영관아이디='"+ScreenId+"'";
         ResultSet r = stmt.executeQuery(p);
         r.first();
         String checking = r.getString(1);
        ...
        String movie_list = "select 영화아이디 from 영화";
        String s = "select * from 상영관 where 영화아이디=" + "'" + checking + "'";
     	System.out.println(s);
     	
     	String movieId = checking;
